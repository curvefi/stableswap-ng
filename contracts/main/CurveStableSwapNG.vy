...
last_prices_packed: DynArray[uint256, MAX_COINS]  #  [last_price, ma_price]
...
def remove_liquidity_one_coin(
    ...
    log RemoveLiquidityOne(msg.sender, i, _burn_amount, dy, total_supply)
